  ...
  children: [
    Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Colors.white,
        image: DecorationImage(image: AssetImage('assets/image/foodpanbanner.jpeg'),fit: BoxFit.cover),
      ),
    ),
  Expanded(
    child: Container(
      ...
      child:Column(
        ...
        children: [
          BigText(text: 'Nutritous Dessert of this city'),
      ...
      child: Stack(
        children:[
          ...
          decoration: BoxDecoration(
            ...
            color: index.isEven?Color(0xFF69c3aa):Color(0xFF9292ae),
            image: DecorationImage(fit:BoxFit.cover,image:AssetImage("assets/image/foodpanbanner.jpeg"))
          ),
        ),
          Align(
